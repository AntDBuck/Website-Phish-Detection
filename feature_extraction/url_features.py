...
# The following file was provided with the dataset. I take no ownership of this file.
# I have made certain modifications for use in my own project.
...
HINTS = ['wp', 'login', 'includes', 'admin', 'content',
